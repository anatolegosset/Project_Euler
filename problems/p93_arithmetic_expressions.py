from pe_lib import generate_permutation, generate_cartesian_product, concat_ints
...
def _compose_apply(function, permutation, variable_dict):
    try:
        innermost_value = function[2](variable_dict[permutation[2]], variable_dict[permutation[3]])
    except ValueError:
        return set()
    ...
    if function[1] in [_sub, _div]:
        possible_values1 = []
        try:
            possible_values1.append(function[1](variable_dict[permutation[1]], innermost_value))
        except ValueError:
            pass
        try:
            possible_values1.append(function[1](innermost_value, variable_dict[permutation[1]]))
        except ValueError:
            pass
    else:
    ...
    for possible_value in possible_values1:
        if function[0] in [_sub, _div]:
            try:
                possible_results.append(function[0](variable_dict[permutation[0]], possible_value))
            except ValueError:
                pass
            try:
                possible_results.append(function[0](possible_value, variable_dict[permutation[0]]))
            except ValueError:
                pass
        else:
            possible_results.append(function[0](variable_dict[permutation[0]], possible_value))
                ...
                for d in range(c + 1, 10):
                    ...
                    for function in functions:
                        ...
                        for permutation in permutations:
                            try:
                                possible_results = _compose_apply(function, permutation, variable_dict)
