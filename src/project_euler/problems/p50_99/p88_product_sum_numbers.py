from src.project_euler.lib import generate_product_partitions, generate_divisors_under
...
def main(max_k=12000):
    ...
    for k in range(2, max_k + 1):
        ...
        for n in range(k + 1, 2 * k):
            product_partitions = generate_product_partitions(
                n, divisors=divisors, max_factors=k
            )
