...
def _is_valid(dice_config1, dice_config2):
    flag_1 = (0 in dice_config1 and 1 in dice_config2) or (
        1 in dice_config1 and 0 in dice_config2
    )
    flag_4 = (0 in dice_config1 and 4 in dice_config2) or (
        4 in dice_config1 and 0 in dice_config2
    )
    ...
    flag_25 = (2 in dice_config1 and 5 in dice_config2) or (
        5 in dice_config1 and 2 in dice_config2
    )
    ...
    flag_81 = (8 in dice_config1 and 1 in dice_config2) or (
        1 in dice_config1 and 8 in dice_config2
    )
    return (
        flag_1
        and flag_4
